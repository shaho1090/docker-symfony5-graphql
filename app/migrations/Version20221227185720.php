 ...
 */
final class Version20221227185720 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, customer_id INT NOT NULL, vendor_id INT NOT NULL, delivery_time INT NOT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_F52993989395C3F3 (customer_id), INDEX IDX_F5299398F603EE73 (vendor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE trip (id INT AUTO_INCREMENT NOT NULL, ccourier_id INT NOT NULL, request_id INT NOT NULL, state VARCHAR(255) NOT NULL, INDEX IDX_7656F53BA2E33CBF (ccourier_id), UNIQUE INDEX UNIQ_7656F53B427EB8A5 (request_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE trip ADD CONSTRAINT FK_7656F53BA2E33CBF FOREIGN KEY (ccourier_id) REFERENCES user (id)');
